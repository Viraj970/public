...
TOKEN = '7458410262:AAHObDJOgyiqtr62AhB3MItIV9u3EFydQp0'
...
FORWARD_CHANNEL_ID = -1002174694230
CHANNEL_ID = -1002174694230
error_channel_id = -1002174694230
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: *https://t.me/canarydomload/2", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin @its_nobody_xd*", parse_mode='Markdown')
    else:
